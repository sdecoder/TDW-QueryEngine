...
public class OptionsProcessor {
  ...
  private Option confOptions, isSilentOption, execOption, fileOption, isHelpOption ,userOption,passwdOption,dbOption;
  ...
  public OptionsProcessor() {
    ...
    passwdOption = createOptionWithArg(builder, "passwd", "p", "passwd",
            argBuilder.withMinimum(1).withMaximum(1).create());
    dbOption = createOptionWithArg(builder, "dbname", "db", "connect to this database",
            argBuilder.withMinimum(1).withMaximum(1).create());
