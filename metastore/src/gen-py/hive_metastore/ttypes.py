...
class Table:
  ...
  def __init__(self, tableName=None, dbName=None, owner=None, createTime=None, lastAccessTime=None, retention=None, sd=None, priPartition=None, subPartition=None, parameters=None,):
    self.tableName = tableName
    self.dbName = dbName
    self.owner = owner
