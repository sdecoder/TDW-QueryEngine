...
class metastore_Partition {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->parType);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->parKey = new metastore_FieldSchema();
            $xfer += $this->parKey->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->parType !== null) {
      $xfer += $output->writeFieldBegin('parType', TType::STRING, 4);
      $xfer += $output->writeString($this->parType);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->parKey !== null) {
      if (!is_object($this->parKey)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('parKey', TType::STRUCT, 5);
      $xfer += $this->parKey->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->parSpaces !== null) {
      if (!is_array($this->parSpaces)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('parSpaces', TType::MAP, 6);
      {
        $output->writeMapBegin(TType::STRING, TType::LST, count($this->parSpaces));
        {
          foreach ($this->parSpaces as $kiter59 => $viter60)
          {
            $xfer += $output->writeString($kiter59);
            {
              $output->writeListBegin(TType::STRING, count($viter60));
              {
...
class metastore_Table {
  ...
  public $sd = null;
  public $priPartition = null;
  public $subPartition = null;
  public $parameters = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['priPartition'])) {
        $this->priPartition = $vals['priPartition'];
      }
      if (isset($vals['subPartition'])) {
        $this->subPartition = $vals['subPartition'];
      }
      if (isset($vals['parameters'])) {
        $this->parameters = $vals['parameters'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 8:
          if ($ftype == TType::STRUCT) {
            $this->priPartition = new metastore_Partition();
            $xfer += $this->priPartition->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 9:
          if ($ftype == TType::STRUCT) {
            $this->subPartition = new metastore_Partition();
            $xfer += $this->subPartition->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->priPartition !== null) {
      if (!is_object($this->priPartition)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('priPartition', TType::STRUCT, 8);
      $xfer += $this->priPartition->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->subPartition !== null) {
      if (!is_object($this->subPartition)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      $xfer += $output->writeFieldBegin('subPartition', TType::STRUCT, 9);
      $xfer += $this->subPartition->write($output);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->parameters !== null) {
      if (!is_array($this->parameters)) {
  ...
  public function write($output) {
    ...
    if ($this->colNames !== null) {
      ...
      $xfer += $output->writeFieldBegin('colNames', TType::LST, 5);
      {
        ...
        {
          foreach ($this->colNames as $iter77)
          {
  ...
  public function write($output) {
    ...
    if ($this->fieldSchemas !== null) {
      ...
      $xfer += $output->writeFieldBegin('fieldSchemas', TType::LST, 1);
      {
        ...
        {
          foreach ($this->fieldSchemas as $iter91)
          {
    ...
    if ($this->properties !== null) {
      ...
      $xfer += $output->writeFieldBegin('properties', TType::MAP, 2);
      {
        ...
        {
          foreach ($this->properties as $kiter92 => $viter93)
          {
