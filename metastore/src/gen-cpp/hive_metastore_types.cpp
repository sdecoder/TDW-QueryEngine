...
const char* Partition::ascii_fingerprint = "8D17C3980D5D53A4766ACCB56A44A83B";
const uint8_t Partition::binary_fingerprint[16] = {0x8D,0x17,0xC3,0x98,0x0D,0x5D,0x53,0xA4,0x76,0x6A,0xCC,0xB5,0x6A,0x44,0xA8,0x3B};
...
uint32_t Partition::read(apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == apache::thrift::protocol::T_STRING) {
          xfer += iprot->readString(this->parType);
          this->__isset.parType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 5:
        if (ftype == apache::thrift::protocol::T_STRUCT) {
          xfer += this->parKey.read(iprot);
          this->__isset.parKey = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
        ...
        if (ftype == apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i44 = 0; _i44 < _size40; ++_i44)
            {
              ...
              std::vector<std::string> & _val46 = this->parSpaces[_key45];
              {
                _val46.clear();
                uint32_t _size47;
                ...
                {
                  xfer += iprot->readString(_val46[_i51]);
                }
                iprot->readListEnd();
              }
            }
...
uint32_t Partition::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("parType", apache::thrift::protocol::T_STRING, 4);
  xfer += oprot->writeString(this->parType);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("parKey", apache::thrift::protocol::T_STRUCT, 5);
  xfer += this->parKey.write(oprot);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("parSpaces", apache::thrift::protocol::T_MAP, 6);
  {
    xfer += oprot->writeMapBegin(apache::thrift::protocol::T_STRING, apache::thrift::protocol::T_LIST, this->parSpaces.size());
    std::map<std::string, std::vector<std::string> > ::const_iterator _iter52;
    for (_iter52 = this->parSpaces.begin(); _iter52 != this->parSpaces.end(); ++_iter52)
    {
      xfer += oprot->writeString(_iter52->first);
      {
        xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRING, _iter52->second.size());
...
const char* Table::ascii_fingerprint = "61100BFC055642B6384526B36DF999E9";
const uint8_t Table::binary_fingerprint[16] = {0x61,0x10,0x0B,0xFC,0x05,0x56,0x42,0xB6,0x38,0x45,0x26,0xB3,0x6D,0xF9,0x99,0xE9};
...
uint32_t Table::read(apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 8:
        if (ftype == apache::thrift::protocol::T_STRUCT) {
          xfer += this->priPartition.read(iprot);
          this->__isset.priPartition = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 9:
        if (ftype == apache::thrift::protocol::T_STRUCT) {
          xfer += this->subPartition.read(iprot);
          this->__isset.subPartition = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
        ...
        if (ftype == apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i58 = 0; _i58 < _size54; ++_i58)
            {
              ...
              std::string& _val60 = this->parameters[_key59];
...
uint32_t Table::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("priPartition", apache::thrift::protocol::T_STRUCT, 8);
  xfer += this->priPartition.write(oprot);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("subPartition", apache::thrift::protocol::T_STRUCT, 9);
  xfer += this->subPartition.write(oprot);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("parameters", apache::thrift::protocol::T_MAP, 10);
  {
    xfer += oprot->writeMapBegin(apache::thrift::protocol::T_STRING, apache::thrift::protocol::T_STRING, this->parameters.size());
        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          {
            ...
            this->colNames.resize(_size62);
            uint32_t _i66;
            for (_i66 = 0; _i66 < _size62; ++_i66)
            {
              xfer += iprot->readString(this->colNames[_i66]);
            }
            iprot->readListEnd();
          }
...
uint32_t Index::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("colNames", apache::thrift::protocol::T_LIST, 5);
  {
    ...
    for (_iter67 = this->colNames.begin(); _iter67 != this->colNames.end(); ++_iter67)
    {
        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          {
            ...
            this->fieldSchemas.resize(_size68);
            uint32_t _i72;
            for (_i72 = 0; _i72 < _size68; ++_i72)
            {
              xfer += this->fieldSchemas[_i72].read(iprot);
            }
            iprot->readListEnd();
          }
...
uint32_t Schema::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("fieldSchemas", apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<FieldSchema> ::const_iterator _iter80;
    for (_iter80 = this->fieldSchemas.begin(); _iter80 != this->fieldSchemas.end(); ++_iter80)
    {
