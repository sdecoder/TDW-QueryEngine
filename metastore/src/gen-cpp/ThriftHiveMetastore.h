...
class ThriftHiveMetastoreIf : virtual public facebook::fb303::FacebookServiceIf {
 public:
  ...
  virtual void get_partition(Partition& _return, const std::string& db_name, const std::string& tbl_name, const int32_t level) = 0;
  virtual void get_partitions(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name) = 0;
...
class ThriftHiveMetastoreNull : virtual public ThriftHiveMetastoreIf , virtual public facebook::fb303::FacebookServiceNull {
 public:
  ...
  void get_partition(Partition& /* _return */, const std::string& /* db_name */, const std::string& /* tbl_name */, const int32_t /* level */) {
    return;
  }
  void get_partitions(std::vector<Partition> & /* _return */, const std::string& /* db_name */, const std::string& /* tbl_name */) {
    return;
  }
...
class ThriftHiveMetastore_get_partition_args {
 public:
  ...
  ThriftHiveMetastore_get_partition_args() : db_name(""), tbl_name(""), level(0) {
  }
  ...
  struct __isset {
    __isset() : db_name(false), tbl_name(false), level(false) {}
    bool db_name;
    bool tbl_name;
    bool level;
  } __isset;
...
class ThriftHiveMetastore_get_partitions_args {
 public:
  ...
  ThriftHiveMetastore_get_partitions_args() : db_name(""), tbl_name("") {
  }
  ...
  struct __isset {
    __isset() : db_name(false), tbl_name(false) {}
    bool db_name;
    bool tbl_name;
  } __isset;
...
class ThriftHiveMetastoreClient : virtual public ThriftHiveMetastoreIf, public facebook::fb303::FacebookServiceClient {
 public:
  ...
  void get_partition(Partition& _return, const std::string& db_name, const std::string& tbl_name, const int32_t level);
  void send_get_partition(const std::string& db_name, const std::string& tbl_name, const int32_t level);
  void recv_get_partition(Partition& _return);
  void get_partitions(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name);
  void send_get_partitions(const std::string& db_name, const std::string& tbl_name);
...
class ThriftHiveMetastoreMultiface : virtual public ThriftHiveMetastoreIf, public facebook::fb303::FacebookServiceMultiface {
 ...
 public:
  ...
  void get_partition(Partition& _return, const std::string& db_name, const std::string& tbl_name, const int32_t level) {
    ...
    for (uint32_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->get_partition(_return, db_name, tbl_name, level);
        return;
      } else {
        ifaces_[i]->get_partition(_return, db_name, tbl_name, level);
      }
  ...
  void get_partitions(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name) {
    ...
    for (uint32_t i = 0; i < sz; ++i) {
      if (i == sz - 1) {
        ifaces_[i]->get_partitions(_return, db_name, tbl_name);
        return;
      } else {
        ifaces_[i]->get_partitions(_return, db_name, tbl_name);
      }
