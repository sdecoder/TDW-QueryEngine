...
public class TblPriv implements TBase, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("TblPriv");
  ...
  private static final TField SELECT_PRIV_FIELD_DESC = new TField("selectPriv", TType.BOOL, (short)4);
  private static final TField INSERT_PRIV_FIELD_DESC = new TField("insertPriv", TType.BOOL, (short)5);
  private static final TField INDEX_PRIV_FIELD_DESC = new TField("indexPriv", TType.BOOL, (short)6);
  private static final TField CREATE_PRIV_FIELD_DESC = new TField("createPriv", TType.BOOL, (short)7);
  private static final TField DROP_PRIV_FIELD_DESC = new TField("dropPriv", TType.BOOL, (short)8);
  private static final TField DELETE_PRIV_FIELD_DESC = new TField("deletePriv", TType.BOOL, (short)9);
  private static final TField ALTER_PRIV_FIELD_DESC = new TField("alterPriv", TType.BOOL, (short)10);
  private static final TField UPDATE_PRIV_FIELD_DESC = new TField("updatePriv", TType.BOOL, (short)11);
  ...
  public static final int SELECTPRIV = 4;
  private boolean insertPriv;
  public static final int INSERTPRIV = 5;
  private boolean indexPriv;
  public static final int INDEXPRIV = 6;
  private boolean createPriv;
  public static final int CREATEPRIV = 7;
  private boolean dropPriv;
  public static final int DROPPRIV = 8;
  private boolean deletePriv;
  public static final int DELETEPRIV = 9;
  private boolean alterPriv;
  public static final int ALTERPRIV = 10;
  private boolean updatePriv;
  public static final int UPDATEPRIV = 11;
  ...
  static {
    FieldMetaData.addStructMetaDataMap(TblPriv.class, metaDataMap);
  }
