...
public class Role implements TBase, java.io.Serializable, Cloneable {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.playRoles = new ArrayList<String>(_list57.size);
              for (int _i58 = 0; _i58 < _list57.size; ++_i58)
              {
                String _elem59;
                _elem59 = iprot.readString();
                this.playRoles.add(_elem59);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.playRoles != null) {
      oprot.writeFieldBegin(PLAY_ROLES_FIELD_DESC);
      {
        ...
        for (String _iter60 : this.playRoles)        {
