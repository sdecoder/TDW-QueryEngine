...
public class MDbPriv {
	...
	public MDbPriv(MDatabase db, String user, boolean select_priv,boolean insert_priv, 
			boolean index_priv, boolean create_priv, boolean drop_priv,boolean delete_priv, 
			boolean alter_priv, boolean update_priv, boolean createview_priv,boolean showview_priv){
		this.db = db;
		this.user = user;
