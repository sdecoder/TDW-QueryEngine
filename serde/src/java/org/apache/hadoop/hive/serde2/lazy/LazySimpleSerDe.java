...
//charset support - Taojiang 2010.10
...
// charset support - Taojiang 2010.10
      if (!charset.equalsIgnoreCase("utf-8")) {
        String s;
        try {
          s = new String(t.getBytes(), 0, t.getLength(), charset);
        } catch (UnsupportedEncodingException e) {
          throw new SerDeException("charset: " + charset + " is unsupported");
        }
        t = new Text(s);
      }
// END OF charset support
