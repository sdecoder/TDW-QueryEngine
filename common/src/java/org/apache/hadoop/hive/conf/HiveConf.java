...
public class HiveConf extends Configuration {
  ...
  public static enum ConfVars {
    ...
    HIVEJOINCACHESIZE("hive.join.cache.size", 25000),              //Added by Brantzhang for patch HIVE-963
    HIVEMAPJOINBUCKETCACHESIZE("hive.mapjoin.bucket.cache.size", 100), //Added by Brantzhang for patch HIVE-1158
    HIVEMAPJOINROWSIZE("hive.mapjoin.size.key", 10000),
    //HIVEMAPJOINCACHEROWS("hive.mapjoin.cache.numrows", 10000),   //Removed by Brantzhang for patch HIVE-827
    HIVEMAPJOINCACHEROWS("hive.mapjoin.cache.numrows", 25000),     //Added by Brantzhang for patch HIVE-827
	...
	HIVEOPTHASHMAPJOIN("hive.optimize.hashmapjoin", false);//Added by Brantzhang for hash map join
