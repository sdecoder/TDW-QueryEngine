...
public class OperatorFactory {
  ...
  static {
    ...
    opvec.add(new opTuple<partitionSinkDesc> (partitionSinkDesc.class, PartitionerOperator.class));
    ...
    // Add by WangYouwei 
    // Sub mode: computing balancer;
    opvec.add(new opTuple<statsDesc> (statsDesc.class, StatsCollectionOperator.class));
    opvec.add(new opTuple<histogramDesc> (histogramDesc.class, HistogramOperator.class));
    opvec.add(new opTuple<sampleDesc> (sampleDesc.class, SampleOperator.class));
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
	
	// Added By xinjieli: This is for the TOP Clause implementation.
	opvec.add(new opTuple<halfSortLimitDesc> (halfSortLimitDesc.class, HalfSortLimitOperator.class));
	// End of adding by xinjieli.
  }
