...
public class ParseContext {
  ...
  private Map<MapJoinOperator, QBJoinTree> mapJoinContext; //Added by brantzhang for hash map join
  ...
  public ParseContext(HiveConf conf, QB qb, ASTNode ast,
      ...
      LinkedHashMap<String, Operator<? extends Serializable>> topOps,//Modified by Brantzhang
   ...
   */
  public void setTopToTable(HashMap<TableScanOperator, TablePartition> topToTable) {
    this.topToTable = topToTable;
  }
  /**
   ...
   * @return the topOps
   */
  public LinkedHashMap<String, Operator<? extends Serializable>> getTopOps() { //Modified by Brantzhang 
    return topOps;
  }
