...
public class MapJoinFactory {
  ...
  public static class MapJoin implements NodeProcessor {
    ...
    public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx,
      ...
      tableDesc tt_desc = 
        //PlanUtils.getIntermediateFileTableDesc(PlanUtils.sortFieldSchemas(    // Removed by Brantzhang for patch HIVE-921
            //PlanUtils.getFieldSchemasFromRowSchema(mapJoin.getSchema(), "temporarycol")));   // Removed by Brantzhang for patch HIVE-921
    	//Added by Brantzhang for patch HIVE-921 Begin
    	PlanUtils.getIntermediateFileTableDesc(
    		PlanUtils.getFieldSchemasFromRowSchema(mapJoin.getSchema(), "temporarycol"));   
    	//Added by Brantzhang for patch HIVE-921 End
