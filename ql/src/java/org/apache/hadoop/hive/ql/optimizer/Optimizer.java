...
public class Optimizer {
  ...
  public void initialize(HiveConf hiveConf) {
    ...
    transformations.add(new JoinReorder());    //Added by Brantzhang for patch HIVE-853
    //Modified by Brantzhang for hash map join begin
    if (HiveConf.getBoolVar(hiveConf, HiveConf.ConfVars.HIVEOPTHASHMAPJOIN)) {
    	transformations.add(new HashMapJoinOptimizer());
    }
    //Modified by Brantzhang for hash map join end
  }
