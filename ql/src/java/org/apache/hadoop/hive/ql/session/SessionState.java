...
public class SessionState {
	...
	public static SessionState start(HiveConf conf) {
		...
		console.printInfo("session : " + ss.getConf().getVar(HiveConf.ConfVars.HIVESESSIONID) + " start!");
	...
	public static SessionState start(SessionState startSs) {
		...
		LogHelper console = getConsole();
		console.printInfo("session : " + startSs.getConf().getVar(HiveConf.ConfVars.HIVESESSIONID) + " start!");
	...
	public static class LogHelper {
		...
		//add by allison,for print debug
		//2010-3-17
		protected HiveConf conf;
