...
public class ExecReducer extends MapReduceBase implements Reducer {
  ...
  public void configure(JobConf job) {
    ...
    try {
      ...
      //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      // FIXME: Author : Wangyouwei  	
      //	System.out.println(" ExecReducer.configuration calls ComputationBalancerReducer.Init");
      	cbr = new ComputationBalancerReducer();
      	cbr.setJobConf(jc);
      	String tableNameString = jc.get(ComputationBalancerReducer.CBR_TABLENAME_ATTR);
      	cbr.setTableName(tableNameString);
      	String tableDataLocationString = jc.get(ComputationBalancerReducer.CBR_TABLEDATALOCATION_ATTR);
      ...
      //	System.out.println("\t[Trace] the top level of flush file is " + _s);
      	cbr.setDestURI("/tmp//hive-wangyouwei//" + _s + "//" );
    //  	System.out.println("[Trace] DestURI: " + cbr.getDestURI());
  ...
  public void reduce(Object key, Iterator values,
    ...
    try {
      ...
      //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      // Author: wangyouwei
      // get the final byte of tag
      byte _byte_ =keyWritable.get()[keyWritable.getSize() - 1];
     // System.out.println("[Trace] cbr.reduce: the final byte of the tag is "+ _byte_);
      //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      //Author: WangYouwei
      //Function: Computation Balancer[Reducer process]
      // TODO: Additional reduce logic here
      // we should seperate our key from original data flow;
      if(_byte_ == StatsCollectionOperator.streamTag ||
    	 _byte_ == SampleOperator.streamTag ||
    	 _byte_ == HistogramOperator.streamTag){
      //if ( tag.get() == StatsCollectionOperator.streamTag ){   	  
    	//  System.out.println("[Trace] ExecReducer.reduce()");
  ...
  public void close() {
    ...
    try {
      ...
      //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      // System.out.println("[Debug] After <reducer.close(abort);> Before <cbr.close();>");
       // Author: wangyouwei
       assert(cbr != null);
       cbr.close();
      // System.out.println("[Debug] After  <cbr.close();>");
       //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
