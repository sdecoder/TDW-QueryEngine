    ...
    try {
      ...
      if (tbd != null) {
        ...
        if (work.getCheckFileFormat()) {
          ...
          try {
            fs = FileSystem.get
              (db.getTable(SessionState.get().getDbName(), tbd.getTable().getTableName()).getDataLocation(),conf);
