...
public class PlanUtils {
  ...
  public static List<FieldSchema> getFieldSchemasFromColumnInfo(Vector<ColumnInfo> cols, String fieldPrefix) {
    //Added by Brantzhang for patch HIVE-1038 Begin
	if ((cols == null) || (cols.size() == 0))
	  return new ArrayList<FieldSchema>(); 
	//Added by Brantzhang for patch HIVE-1038 End
  ...
  public static halfSortLimitDesc getHalfSortLimitDesc(ArrayList<exprNodeDesc> sortCols, String order, int limit) {
